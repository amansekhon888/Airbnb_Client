import { CheckCircleOutlined, KeyboardArrowLeftOutlined, KeyboardArrowRightOutlined, LanguageOutlined, StarRateRounded } from "@mui/icons-material"
                            ...
                            <div className="flex flex-col md:flex-row sm:items-center justify-start gap-4 sm:gap-6 text-center sm:text-left ">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h4 className="text-2xl font-semibold mt-1">Paul Lankford</h4>
                                    ...
                                    <div className="mt-3 font-medium">
                                        ...
                                        <ul className="flex flex-wrap justify-center sm:justify-start items-center gap-3 mt-1 text-sm">
                                            <li className="flex items-center gap-1">
                                                <CheckCircleOutlined className="!text-lg text-green-500" /> 7 Years hosting
                                            </li>
                                            <li className="flex items-center gap-1">
                                                <CheckCircleOutlined className="!text-lg text-green-500" /> Email address
                                            </li>
                                            <li className="flex items-center gap-1">
                                                <CheckCircleOutlined className="!text-lg text-green-500" /> Phone number
                                            </li>
                                            <li className="flex items-center gap-1">
                                            ...
                                            <div className="">
                                                ...
                                                <div className='pt-3'>
                                                    <div className="flex items-start justify-between gap-4">
                                                        <h4 className=" font-medium text-text1 leading-5"><Link to="/property-details/1">Lorem ipsum dolor sit amet
                                                        </Link></h4>
