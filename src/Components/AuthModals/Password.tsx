        ...
        <div>
            <div className="">
                <form action="" onSubmit={handleLogin}>
                    ...
                    <div className='mt-2'>
                        <p className='text-text-1 underline font-medium text-sm text-end'><span className='cursor-pointer' onClick={() => setStep("ForgotPassword")}>Forgotten your password?</span></p>
                    </div>
                    <div className="mt-5">
