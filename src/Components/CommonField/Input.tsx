        ...
        <div className="">
            ...
            <div className='relative'>
                <input
                    ...
                    name={name}
                    className={classNames(`${type === "password" ? "pr-10 pl-3" : "px-3"} focus:ring-0 focus:border-primary py-2 text-text1 placeholder:text-text3 border-border1 w-full rounded-md`, inputClass)}
